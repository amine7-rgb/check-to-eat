...
public class Commandeaffiche {
    ...
    public Commandeaffiche(String id, String titre, String date_de_commande,String panierFk1) {
    ...
    public String toString() {
        return "Commande{" + "id=" + id + ", titre=" + titre + ", date_de_commande=" + date_de_commande + ", panierFK=" + panierFK + '}';
    }
