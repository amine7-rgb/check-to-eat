...
loaddata();    }    
    ...
    private void modifier(ActionEvent event) {
         Utilisateur upuser = new Utilisateur(idu, txt_nom.getText(), txt_prenom.getText(), Integer.parseInt(txt_num.getText()), passe.getText(), txt_genre.getText(), txt_email.getText(),role.getText(),img.getText());
